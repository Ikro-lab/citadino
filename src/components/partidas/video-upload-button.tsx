...
export function VideoUploadButton({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <label
        className={`inline-flex h-10 cursor-pointer items-center gap-1.5 rounded-lg border border-border px-3 text-sm font-semibold hover:bg-background ${pending ? "pointer-events-none opacity-60" : ""}`}
      >
        <Video size={16} />
