...
export function BottomNav({ role, tenantSlug }: { role: Role | null; tenantSlug: string }) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-surface/95 pb-[env(safe-area-inset-bottom)] backdrop-blur supports-[backdrop-filter]:bg-surface/85 md:hidden">
