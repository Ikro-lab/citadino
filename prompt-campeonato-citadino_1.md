...
- Linha do tempo/lista de momentos da partida: gols (com autor e minuto), cartões amarelos/vermelhos (com jogador e minuto), outros eventos relevantes. **O nome de cada atleta citado é clicável e leva ao seu perfil público.**
- Estatísticas básicas se disponíveis (ex: escanteios, faltas — opcional, conforme o que for coletado).
- Escalação ou lista de atletas relacionados de cada time (opcional/expansível), também com nomes clicáveis para o perfil.
