/*
  ...
  - Made the column `tenantId` on table `Atleta` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Campeonato` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Categoria` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Enquete` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `EnqueteOpcao` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `EnqueteVoto` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `EventoPartida` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Grupo` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `InscricaoAtleta` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Partida` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Patrocinador` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `PushSubscription` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `SolicitacaoTime` required. This step will fail if there are existing NULL values in that column.
  - Made the column `tenantId` on table `Time` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Atleta" ("comprovanteEnderecoUrl", "createdAt", "dataNascimento", "documentoUrl", "fotoUrl", "id", "instagram", "nome", "numero", "posicao", "tenantId", "timeId") SELECT "comprovanteEnderecoUrl", "createdAt", "dataNascimento", "documentoUrl", "fotoUrl", "id", "instagram", "nome", "numero", "posicao", "tenantId", "timeId" FROM "Atleta";
DROP TABLE "Atleta";
...
INSERT INTO "new_Campeonato" ("ativo", "createdAt", "id", "nome", "regulamentoUrl", "temporada", "tenantId", "updatedAt") SELECT "ativo", "createdAt", "id", "nome", "regulamentoUrl", "temporada", "tenantId", "updatedAt" FROM "Campeonato";
...
INSERT INTO "new_Categoria" ("campeonatoId", "cartoesParaSuspensao", "classificadosPorGrupo", "createdAt", "formato", "id", "jogosSuspensao", "nome", "regulamentoUrl", "tenantId") SELECT "campeonatoId", "cartoesParaSuspensao", "classificadosPorGrupo", "createdAt", "formato", "id", "jogosSuspensao", "nome", "regulamentoUrl", "tenantId" FROM "Categoria";
...
INSERT INTO "new_Enquete" ("ativa", "categoriaId", "createdAt", "id", "pergunta", "rodada", "tenantId") SELECT "ativa", "categoriaId", "createdAt", "id", "pergunta", "rodada", "tenantId" FROM "Enquete";
DROP TABLE "Enquete";
...
INSERT INTO "new_EnqueteOpcao" ("atletaId", "enqueteId", "id", "tenantId") SELECT "atletaId", "enqueteId", "id", "tenantId" FROM "EnqueteOpcao";
...
INSERT INTO "new_EnqueteVoto" ("createdAt", "deviceId", "enqueteId", "id", "opcaoId", "tenantId") SELECT "createdAt", "deviceId", "enqueteId", "id", "opcaoId", "tenantId" FROM "EnqueteVoto";
...
INSERT INTO "new_EventoPartida" ("atletaId", "createdAt", "descricao", "id", "lancadoPorId", "minuto", "partidaId", "tenantId", "timeId", "tipo", "videoUrl") SELECT "atletaId", "createdAt", "descricao", "id", "lancadoPorId", "minuto", "partidaId", "tenantId", "timeId", "tipo", "videoUrl" FROM "EventoPartida";
...
INSERT INTO "new_Grupo" ("categoriaId", "createdAt", "id", "nome", "tenantId") SELECT "categoriaId", "createdAt", "id", "nome", "tenantId" FROM "Grupo";
DROP TABLE "Grupo";
...
INSERT INTO "new_InscricaoAtleta" ("atletaId", "comprovanteEnderecoUrl", "createdAt", "dataNascimento", "documentoUrl", "fotoUrl", "id", "instagram", "nome", "revisadoEm", "status", "tenantId", "timeId") SELECT "atletaId", "comprovanteEnderecoUrl", "createdAt", "dataNascimento", "documentoUrl", "fotoUrl", "id", "instagram", "nome", "revisadoEm", "status", "tenantId", "timeId" FROM "InscricaoAtleta";
...
INSERT INTO "new_Partida" ("categoriaId", "createdAt", "dataHora", "fase", "golsCasaDetalhe", "id", "linkTransmissaoUrl", "local", "placarCasa", "placarFora", "rodada", "status", "tenantId", "timeCasaId", "timeForaId", "updatedAt") SELECT "categoriaId", "createdAt", "dataHora", "fase", "golsCasaDetalhe", "id", "linkTransmissaoUrl", "local", "placarCasa", "placarFora", "rodada", "status", "tenantId", "timeCasaId", "timeForaId", "updatedAt" FROM "Partida";
DROP TABLE "Partida";
...
INSERT INTO "new_Patrocinador" ("ativo", "campeonatoId", "createdAt", "id", "linkUrl", "logoUrl", "nivel", "nome", "ordem", "tenantId") SELECT "ativo", "campeonatoId", "createdAt", "id", "linkUrl", "logoUrl", "nivel", "nome", "ordem", "tenantId" FROM "Patrocinador";
...
INSERT INTO "new_PushSubscription" ("auth", "categoriaId", "createdAt", "endpoint", "id", "lembreteMin", "p256dh", "tenantId", "timeId") SELECT "auth", "categoriaId", "createdAt", "endpoint", "id", "lembreteMin", "p256dh", "tenantId", "timeId" FROM "PushSubscription";
...
INSERT INTO "new_SolicitacaoTime" ("categoriaId", "createdAt", "id", "mensagem", "nomeTime", "status", "tenantId", "timeId", "treinadorId") SELECT "categoriaId", "createdAt", "id", "mensagem", "nomeTime", "status", "tenantId", "timeId", "treinadorId" FROM "SolicitacaoTime";
...
INSERT INTO "new_Time" ("categoriaId", "conviteToken", "createdAt", "escudoUrl", "grupoId", "id", "nome", "tenantId", "treinadorId") SELECT "categoriaId", "conviteToken", "createdAt", "escudoUrl", "grupoId", "id", "nome", "tenantId", "treinadorId" FROM "Time";
DROP TABLE "Time";
